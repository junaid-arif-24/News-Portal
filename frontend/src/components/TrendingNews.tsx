        ...
        <div className="md:flex">
          ...
          <div className="md:w-2/3 p-4">
            <div className="bg-white p-4 rounded-lg shadow-md">
              <img src={staticData[0].image} alt={staticData[0].title} className="w-full h-64 object-cover rounded-lg mb-4" />
          ...
          {/* Side News */}
          <div className="md:w-1/3 p-4 space-y-4 max-h-[calc(100vh-150px)] overflow-y-auto">
